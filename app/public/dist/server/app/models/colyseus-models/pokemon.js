...
const conversionEffect = ({ simulation, player, entity }) => {
    ...
    if (synergyCopied === Synergy_1.Synergy.BUG) {
        ...
        const coord = simulation.getClosestAvailablePlaceOnBoardToPokemon(entity, player.team);
    ...
    if (synergyCopied === Synergy_1.Synergy.DRAGON) {
        ...
        if (effect === Effect_1.Effect.DRAGON_SCALES || effect === Effect_1.Effect.DRAGON_DANCE) {
            entity.addShield(dragonLevel * 5, entity, 0, false);
        }
        if (effect === Effect_1.Effect.DRAGON_DANCE) {
...
class Charcadet extends Pokemon {
    constructor() {
        ...
        this.evolutionRule = new evolution_rules_1.ItemEvolutionRule(Item_1.CharcadetArmors, (pokemon, player, item_) => {
            const item = item_;
        ...
        this.onAcquired = (player) => {
            player.items.push(Item_1.Item.AUSPICIOUS_ARMOR);
            player.items.push(Item_1.Item.MALICIOUS_ARMOR);
        };
    }
}
