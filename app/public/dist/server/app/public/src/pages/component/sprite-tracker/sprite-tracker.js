...
function SpriteOnlyRow({ index, style, groups, normalLabel, shinyLabel, getSpriteCollabUrl, getPacPortraitUrl, getImageFallback }) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { style: style, children: (0, jsx_runtime_1.jsx)("div", { className: "entry my-box sprite-only-entry", children: (0, jsx_runtime_1.jsx)("div", { className: "entry-header", children: (0, jsx_runtime_1.jsxs)("div", { className: "entry-info grouped-row", children: [(0, jsx_runtime_1.jsxs)("div", { className: "entry-portraits", children: [(0, jsx_runtime_1.jsx)("img", { className: "pokemon-portrait entry-portrait", src: (_d = normalEntry.portraitUrl) !== null && _d !== void 0 ? _d : getPacPortraitUrl(normalEntry.index), onError: getImageFallback }), shinyEntry && ((0, jsx_runtime_1.jsx)("img", { className: "pokemon-portrait entry-portrait", src: (_e = shinyEntry.portraitUrl) !== null && _e !== void 0 ? _e : getPacPortraitUrl(shinyEntry.index), onError: getImageFallback }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "entry-text", children: [(0, jsx_runtime_1.jsx)("div", { className: "entry-line", children: (0, jsx_runtime_1.jsx)("a", { className: "pokemon-name entry-title entry-name-link", href: getSpriteCollabUrl(normalEntry.index), target: "_blank", rel: "noreferrer", children: title }) }), (0, jsx_runtime_1.jsxs)("div", { className: "entry-line entry-summary", children: [normalIndex && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: "entry-kind", children: normalLabel }), (0, jsx_runtime_1.jsx)("strong", { children: normalIndex })] })), normalIndex && shinyIndex && ((0, jsx_runtime_1.jsx)("span", { className: "entry-separator", children: "|" })), shinyIndex && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: "entry-kind", children: shinyLabel }), (0, jsx_runtime_1.jsx)("strong", { children: shinyIndex })] }))] })] })] }) }) }) }));
}
...
function SpriteTracker() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "sprite-tracker", children: [(0, jsx_runtime_1.jsx)("div", { className: "refresh-info", children: (0, jsx_runtime_1.jsx)("small", { children: t("sprite_tracker.summary_line", {
                        ...
                        }), checked: filterAlcremie, onToggle: setFilterAlcremie, isDark: true })] }), (0, jsx_runtime_1.jsx)("div", { className: "content", children: groupedSpriteOnly.length === 0 ? ((0, jsx_runtime_1.jsx)("p", { className: "empty-state", children: t("no_results_found") })) : ((0, jsx_runtime_1.jsx)(react_virtualized_auto_sizer_1.AutoSizer, { renderProp: ({ height, width }) => {
