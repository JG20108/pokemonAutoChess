...
function TournamentItem(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "tournament-item my-box", children: [(0, jsx_runtime_1.jsxs)("span", { className: "tournament-name", children: [(0, jsx_runtime_1.jsx)("img", { width: "32", height: "32", src: "assets/ui/tournament.svg", style: { marginRight: "0.5em", verticalAlign: "text-bottom" } }), props.tournament.name] }), tournamentFinished ? ((0, jsx_runtime_1.jsx)("div", { children: (0, tournament_logic_1.getTournamentStage)(props.tournament) })) : tournamentStarted ? ((0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", justifyContent: "space-between" }, children: [(0, jsx_runtime_1.jsx)("span", { children: (0, tournament_logic_1.getTournamentStage)(props.tournament) }), (0, jsx_runtime_1.jsxs)("span", { children: [t("players_remaining"), ": ", remainingPlayers.length] })] })) : ((0, jsx_runtime_1.jsxs)("p", { children: [t("starts_at"), " ", (0, date_1.formatDate)(new Date(props.tournament.startDate), {
                        dateStyle: "long"
                    })] })), !tournamentStarted && !tournamentFinished && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [user && user.level < gadgets_1.GADGETS.certificate.levelRequired && ((0, jsx_runtime_1.jsx)("p", { children: t("level_required") })), (0, jsx_runtime_1.jsx)("div", { className: "actions", children: participating ? ((0, jsx_runtime_1.jsx)("button", { className: "participate-btn bubbly green", title: t("cancel_tournament_participation"), disabled: !registrationsOpen ||
                                (user && user.level < gadgets_1.GADGETS.certificate.levelRequired), onClick: () => {
                                (0, network_1.participateInTournament)({
                                    tournamentId: props.tournament.id,
                                    participate: false
                                });
                            }, children: t("participating") })) : registrationsOpen ? ((0, jsx_runtime_1.jsx)("button", { className: "participate-btn bubbly blue", title: t("register_tournament_participation"), disabled: !registrationsOpen ||
                                (user && user.level < gadgets_1.GADGETS.certificate.levelRequired), onClick: () => {
                                (0, network_1.participateInTournament)({
                                    tournamentId: props.tournament.id,
                                    participate: true
                                });
                            }, children: t("participate") })) : null })] })), (0, jsx_runtime_1.jsxs)(react_tabs_1.Tabs, { children: [(0, jsx_runtime_1.jsxs)(react_tabs_1.TabList, { children: [tournamentStarted && (0, jsx_runtime_1.jsx)(react_tabs_1.Tab, { children: t("brackets") }), (tournamentStarted || tournamentFinished) && ((0, jsx_runtime_1.jsx)(react_tabs_1.Tab, { children: t("ranking") })), (registrationsOpen || tournamentStarted) && ((0, jsx_runtime_1.jsxs)(react_tabs_1.Tab, { children: [t("participants"), " (", players.length, ")"] }))] }), !registrationsOpen && !tournamentStarted && ((0, jsx_runtime_1.jsx)("p", { children: t("registrations_open_info") })), tournamentStarted && ((0, jsx_runtime_1.jsx)(react_tabs_1.TabPanel, { className: "brackets", children: brackets.map((bracket) => ((0, jsx_runtime_1.jsxs)("div", { className: "bracket", children: [(0, jsx_runtime_1.jsx)("p", { children: bracket.name }), (0, jsx_runtime_1.jsx)("ul", { children: (0, schemas_1.schemaValues)(bracket.playersId).map((id, i) => ((0, jsx_runtime_1.jsx)(TournamentPlayer, { playerId: id, player: props.tournament.players.get(id), rank: i + 1, showScore: false }, "player" + i))) })] }, bracket.name))) })), (tournamentStarted || tournamentFinished) && ((0, jsx_runtime_1.jsx)(react_tabs_1.TabPanel, { className: "ranking", children: (0, jsx_runtime_1.jsx)("ul", { children: sortedPlayers.map(([id, player], i) => ((0, jsx_runtime_1.jsx)(TournamentPlayer, { playerId: id, player: player, rank: i + 1, showScore: true }, "player" + i))) }) })), (registrationsOpen || tournamentStarted) && ((0, jsx_runtime_1.jsx)(react_tabs_1.TabPanel, { className: "participants", children: (0, jsx_runtime_1.jsx)("ul", { children: (0, schemas_1.schemaEntries)(props.tournament.players).map(([id, player], i) => ((0, jsx_runtime_1.jsx)(TournamentPlayer, { playerId: id, player: player, rank: i + 1, showScore: false }, "player" + i))) }) }))] })] }));
}
