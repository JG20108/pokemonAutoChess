...
function Modals({ modal, setModal, page }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(modal_1.Modal, { onClose: closeModal, show: modal === "news", header: t("patch_notes"), className: "patchnotes", children: (0, jsx_runtime_1.jsx)(patchnotes_1.default, {}) }), (0, jsx_runtime_1.jsx)(modal_1.Modal, { onClose: () => {
                ...
                }, show: modal === "profile", header: t("profile.title"), children: (0, jsx_runtime_1.jsx)(profile_1.default, {}) }), (0, jsx_runtime_1.jsx)(modal_1.Modal, { onClose: closeModal, show: modal === "collection", header: t("collection"), className: "anchor-top", children: (0, jsx_runtime_1.jsx)(pokemon_collection_1.default, {}) }), (0, jsx_runtime_1.jsx)(modal_1.Modal, { onClose: closeModal, show: modal === "booster", className: "custom-bg", children: (0, jsx_runtime_1.jsx)(booster_1.default, {}) }), (0, jsx_runtime_1.jsx)(modal_1.Modal, { onClose: closeModal, show: modal === "wiki", className: "wiki-modal", header: t("wiki_label"), children: (0, jsx_runtime_1.jsx)(wiki_1.default, { inGame: page === "game" }) }), (0, jsx_runtime_1.jsx)(modal_1.Modal, { show: modal === "meta", header: t("meta"), onClose: closeModal, children: (0, jsx_runtime_1.jsx)(meta_report_1.default, {}) }), (0, jsx_runtime_1.jsx)(modal_1.Modal, { onClose: closeModal, show: modal === "servers", className: "servers-modal", header: t("community_servers"), children: (0, jsx_runtime_1.jsx)(servers_list_1.default, {}) }), (0, jsx_runtime_1.jsx)(team_builder_modal_1.default, { show: modal === "team-builder", handleClose: closeModal }), (0, jsx_runtime_1.jsx)(team_builder_modal_1.default, { show: modal === "team-builder", handleClose: closeModal }), (0, jsx_runtime_1.jsx)(tier_list_maker_modal_1.default, { show: modal === "tier-list", handleClose: closeModal }), (0, jsx_runtime_1.jsx)(sprite_tracker_modal_1.default, { show: modal === "sprite-tracker", handleClose: closeModal }), (0, jsx_runtime_1.jsx)(game_options_modal_1.default, { show: modal === "options", page: page, hideModal: closeModal }), (0, jsx_runtime_1.jsx)(modal_1.Modal, { onClose: closeModal, show: modal === "tournaments", header: "Tournaments", children: (0, jsx_runtime_1.jsx)(tournaments_admin_1.TournamentsAdmin, {}) }), (0, jsx_runtime_1.jsx)(modal_1.Modal, { onClose: closeModal, show: modal === "moderation", header: "Moderation", children: (0, jsx_runtime_1.jsx)(moderation_panel_1.default, {}) }), (0, jsx_runtime_1.jsx)(jukebox_1.default, { show: modal === "jukebox", handleClose: closeModal }), (0, jsx_runtime_1.jsx)(pokeguesser_1.default, { show: modal === "pokeguesser", handleClose: closeModal }), (0, jsx_runtime_1.jsx)(synergy_wheel_1.default, { show: modal === "synergy-wheel", handleClose: closeModal })] }));
}
