...
function PokemonFamilyRow({ index, style, familiesArray, t }) {
    const [pkm, family] = familiesArray[index];
    return ((0, jsx_runtime_1.jsx)("div", { style: style, children: (0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)(PokemonFamilyCard, { pkm: pkm, family: family, rank: index + 1, t: t }) }) }));
}
