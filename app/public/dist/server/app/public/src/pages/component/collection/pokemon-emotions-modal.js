...
function PokemonEmotionsModal(props) {
    ...
    const [isUnlocking, setIsUnlocking] = (0, react_1.useState)(false);
    ...
    const handleUnlockAll = (0, react_1.useCallback)(() => __awaiter(this, void 0, void 0, function* () {
        setIsUnlocking(true);
        try {
            yield dispatch((0, NetworkStore_1.unlockAllEmotions)());
        }
        finally {
