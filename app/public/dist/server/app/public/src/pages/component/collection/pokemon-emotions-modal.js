...
function PokemonEmotionsModal(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(modal_1.Modal, { show: true, onClose: props.onClose, className: "pokemon-emotions-modal anchor-top", header: (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(pokemon_portrait_1.default, { portrait: {
                        ...
                        emotion: (_c = item.selectedEmotion) !== null && _c !== void 0 ? _c : types_1.Emotion.NORMAL
                            ...
                            }) })] }), shinyAvailable && ((0, jsx_runtime_1.jsxs)("section", { children: [(0, jsx_runtime_1.jsx)("p", { children: t("shiny_emotions") }), (0, jsx_runtime_1.jsx)("div", { children: shinyAvailableEmotions.map((e) => {
                            ...
                            }) })] }))] }), footer: (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("button", { className: "bubbly blue", disabled: (item.emotions.length === 0 && item.shinyEmotions.length === 0) ||
                    ...
                    }, children: [isCurrentAvatar ? t("chosen_as_avatar") : t("choose_as_avatar"), "\u00A0", (0, jsx_runtime_1.jsx)(pokemon_portrait_1.default, { portrait: {
                                index,
                                shiny: item.selectedShiny,
                                emotion: (_e = item.selectedEmotion) !== null && _e !== void 0 ? _e : types_1.Emotion.NORMAL
                            }, alt: "avatar" })] }), (0, jsx_runtime_1.jsxs)("button", { className: "bubbly orange", disabled: shards < boosterCost, onClick: () => (0, network_1.buyBooster)({ index }), children: [t("buy_booster", { cost: boosterCost }), (0, jsx_runtime_1.jsx)("img", { src: (0, avatar_1.getPortraitSrc)(index), className: "dust", alt: "dust" })] }), item.selectedEmotion != null &&
                    item.selectedEmotion != types_1.Emotion.NORMAL && ((0, jsx_runtime_1.jsxs)("button", { className: "bubbly blue", onClick: resetEmotion, children: [t("reset_emotion"), "\u00A0", (0, jsx_runtime_1.jsx)(pokemon_portrait_1.default, { portrait: {
                                index,
                                shiny: false,
                                emotion: types_1.Emotion.NORMAL
                            }, alt: "avatar" })] })), (0, jsx_runtime_1.jsxs)("button", { className: (0, jsx_1.cc)("bubbly", isFavorite ? "red" : "green"), onClick: toggleFavorite, children: ["\u2764\uFE0F\u00A0", isFavorite ? t("remove_from_favorites") : t("add_to_favorites")] })] }) }));
}
