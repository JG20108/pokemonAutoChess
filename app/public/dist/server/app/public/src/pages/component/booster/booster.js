...
function Booster() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { id: "boosters-page", children: [(0, jsx_runtime_1.jsx)("p", { className: "help", children: numberOfBooster === 0 ? t("boosters_hint") : t("open_boosters_hint") }), (0, jsx_runtime_1.jsx)("div", { className: "boosters-content", children: boosterContent.map((pkm, i) => ((0, jsx_runtime_1.jsx)(booster_card_1.BoosterCard, { pkm: pkm, shards: pkm.shiny ? Config_1.DUST_PER_SHINY : Config_1.DUST_PER_BOOSTER, flipped: flippedStates[i], onFlip: () => handleFlip(i) }, "booster" + i))) }), (0, jsx_runtime_1.jsxs)("div", { className: "actions", children: [(0, jsx_runtime_1.jsx)("button", { onClick: onClickOpenBooster, className: (0, jsx_1.cc)("bubbly", { blue: numberOfBooster > 0 }), disabled: numberOfBooster <= 0, children: t("open_booster") }), (0, jsx_runtime_1.jsx)("span", { className: "booster-count", children: numberOfBooster }), (0, jsx_runtime_1.jsx)("img", { src: "/assets/ui/booster.png", alt: "booster" })] })] }));
}
