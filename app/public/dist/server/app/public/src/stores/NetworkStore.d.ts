...
export declare const networkSlice: import("@reduxjs/toolkit").Slice<INetwork, {
    ...
    unlockAllEmotions: (state: import("immer").WritableDraft<INetwork>) => void;
...
export declare const heapSnapshot: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<"network/heapSnapshot">, selectLanguage: import("@reduxjs/toolkit").ActionCreatorWithPayload<Language, "network/selectLanguage">, unban: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    ...
    name: string;
    startDate: string;
}, "network/createTournament">, setConnectionStatus: import("@reduxjs/toolkit").ActionCreatorWithPayload<ConnectionStatus, "network/setConnectionStatus">, setErrorAlertMessage: import("@reduxjs/toolkit").ActionCreatorWithPayload<string | null, "network/setErrorAlertMessage">, deleteAccount: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<"network/deleteAccount">, setPendingGameId: import("@reduxjs/toolkit").ActionCreatorWithPayload<string | null, "network/setPendingGameId">, unlockAllEmotions: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<"network/unlockAllEmotions">;
