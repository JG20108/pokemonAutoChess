...
import { IChatV2, ISuggestionUser, PkmWithCustom } from "../../../types";
...
export declare const lobbySlice: import("@reduxjs/toolkit").Slice<IUserLobbyState, {
    ...
    setBoosterContent: (state: import("immer").WritableDraft<IUserLobbyState>, action: PayloadAction<PkmWithCustom[]>) => void;
...
export declare const removeMessage: import("@reduxjs/toolkit").ActionCreatorWithPayload<Message, "lobby/removeMessage">, setBoosterContent: import("@reduxjs/toolkit").ActionCreatorWithPayload<PkmWithCustom[], "lobby/setBoosterContent">, changePokemonCollectionItem: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    id: string;
    field: string;
    value: any;
