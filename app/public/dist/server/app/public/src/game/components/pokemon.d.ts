...
export declare function addWanderingPokemon(scene: GameScene, id: string, pkm: Pkm, onClick: (pokemon: PokemonSprite, id: string, pointer: Phaser.Input.Pointer, tween: Phaser.Tweens.Tween) => void): void;
