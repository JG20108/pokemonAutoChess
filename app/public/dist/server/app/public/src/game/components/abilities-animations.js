...
function displayAbility(scene, pokemonsOnBoard, skill, orientation, positionX, positionY, targetX, targetY, flip, delay) {
    ...
    switch (skill) {
        ...
        case Ability_1.Ability.FLAME_CHARGE:
            addAbilitySprite(skill, coordinates, true)
                .setScale(2)
                .setDepth(depths_1.DEPTH.ABILITY_BELOW_POKEMON)
                .setOrigin(1, 1)
                .setRotation(Math.atan2(coordinatesTarget[1] - coordinates[1], coordinatesTarget[0] - coordinates[0]) +
                Math.PI / 2);
            break;
        ...
        case Ability_1.Ability.SALT_CURE:
            addAbilitySprite(Ability_1.Ability.MAGIC_POWDER, coordinates, true)
                .setScale(2)
                .setTint(0xb0ff80);
            break;
        ...
        case Ability_1.Ability.THUNDER_SHOCK:
            addAbilitySprite(Ability_1.Ability.THUNDER, coordinatesTarget, true)
                .setScale(2)
                .setOrigin(0.5, 1);
            break;
        ...
        case Ability_1.Ability.SWALLOW:
            addAbilitySprite(Ability_1.Ability.HYDRO_PUMP, coordinates, true)
                .setScale(2)
                .setTint(0x60ff60)
                .setOrigin(0.5, 1)
                .setRotation(Math.atan2(coordinatesTarget[1] - coordinates[1], coordinatesTarget[0] - coordinates[0]) +
        ...
        case Ability_1.Ability.GRAVITY:
            addAbilitySprite(Ability_1.Ability.CALM_MIND, coordinates, true)
                .setScale(3)
                .setTint(0xccff33)
                .setDepth(depths_1.DEPTH.ABILITY_GROUND_LEVEL);
            break;
        ...
        case "SCALE_SHOT_CHARGE": {
            const charge = scene.add
                .sprite(coordinates[0], coordinates[1], "abilities", `${Ability_1.Ability.SCALE_SHOT}/000.png`)
                .setScale(2)
        ...
        case "SOLAR_BLADE_CHARGE": {
            const charge = scene.add
                .sprite(coordinates[0], coordinates[1], "abilities", `${Ability_1.Ability.RECOVER}/000.png`)
                .setScale(3)
                .setDepth(depths_1.DEPTH.ABILITY);
            charge.anims.play({
        ...
        case Ability_1.Ability.GRAV_APPLE: {
            const aboveTargetCoordinates = (0, utils_1.transformAttackCoordinate)(targetX, targetY, flip);
            aboveTargetCoordinates[1] -= 400;
            const apple = addAbilitySprite("NUTRIENTS", aboveTargetCoordinates).setScale(3);
            scene.tweens.add({
                targets: apple,
                x: coordinatesTarget[0],
                y: coordinatesTarget[1],
        ...
        case Ability_1.Ability.SYRUP_BOMB: {
            const specialProjectile = addAbilitySprite("NUTRIENTS", coordinates).setScale(3);
            scene.tweens.add({
                targets: specialProjectile,
                x: coordinatesTarget[0],
                y: coordinatesTarget[1],
        ...
        case Ability_1.Ability.FICKLE_BEAM: {
            const specialProjectile = addAbilitySprite(Ability_1.Ability.FICKLE_BEAM, coordinates).setScale(2);
            scene.tweens.add({
                targets: specialProjectile,
                x: coordinatesTarget[0],
                y: coordinatesTarget[1],
        ...
        case Ability_1.Ability.SUCTION_HEAL: {
            const specialProjectile = addAbilitySprite(skill, coordinatesTarget).setScale(3);
            scene.tweens.add({
                targets: specialProjectile,
                x: coordinates[0],
                y: coordinates[1],
        ...
        case Ability_1.Ability.BULLDOZE:
            addAbilitySprite(Ability_1.Ability.HEAVY_SLAM, coordinates, true).setScale(2);
            break;
        ...
        case Ability_1.Ability.FILLET_AWAY:
            addAbilitySprite(Ability_1.Ability.SHIELDS_UP, coordinates, true).setScale(2);
            break;
        ...
        case "FLAME_HIT":
            addAbilitySprite("FLAME_HIT", coordinates, true)
                .setDepth(depths_1.DEPTH.HIT_FX_BELOW_POKEMON)
                .setScale(2);
            break;
        ...
        case Ability_1.Ability.DECORATE:
            {
                ...
                const [x, y] = (0, utils_1.transformAttackCoordinate)(targetX, targetY, flip);
        ...
        case "ELECTRO_SHOT_CHARGE": {
            const charge = addAbilitySprite(Ability_1.Ability.MAGNET_BOMB, coordinates).setScale(2);
            scene.tweens.add({
                targets: charge,
                duration: 2000,
                x: coordinates[0],
        ...
        case Ability_1.Ability.METAL_CLAW:
            addAbilitySprite(Ability_1.Ability.CRUSH_CLAW, coordinatesTarget, true).setScale(2);
            break;
        case Ability_1.Ability.DRAGON_CLAW:
            addAbilitySprite(Ability_1.Ability.DRAGON_CLAW, coordinatesTarget, true).setScale(1);
            break;
