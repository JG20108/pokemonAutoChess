...
class BattleManager {
    ...
    changeCount(simulationId, pokemon, field, value, previousValue) {
        ...
        if (((_a = this.simulation) === null || _a === void 0 ? void 0 : _a.id) == simulationId &&
            ...
            if (field == "crit") {
                ...
                if (value != 0) {
                    this.animationManager.play(pkm, Pokemon_1.AnimationConfig[Pokemon_1.PkmByIndex[pkm.index]].ability, { flip: this.flip, lock: true, repeat: 0 });
    ...
    changePokemon(simulationId, pokemon, field, value, previousValue) {
        ...
        if (((_a = this.simulation) === null || _a === void 0 ? void 0 : _a.id) == simulationId &&
            ...
            if (field === "positionX" || field === "positionY") {
                ...
                if (value && value > (previousValue || 0)) {
                    this.displayBoost(Game_1.Stat.SPEED, pkm.positionX, pkm.positionY);
                }
                ...
                (_b = pkm.lifebar) === null || _b === void 0 ? void 0 : _b.setMaxAmount(pokemon.hp);
            }
            else if (field == "life") {
                pkm.life = pokemon.life;
                (_c = pkm.lifebar) === null || _c === void 0 ? void 0 : _c.setAmount(pkm.life);
                if (pkm.detail && pkm.detail instanceof pokemon_detail_1.default) {
                ...
                if (pokemon.shield >= 0) {
                    ...
                    (_d = pkm.lifebar) === null || _d === void 0 ? void 0 : _d.setShieldAmount(pkm.shield);
                }
            }
            else if (field === "pp") {
                pkm.pp = pokemon.pp;
                (_e = pkm.powerbar) === null || _e === void 0 ? void 0 : _e.setAmount((0, number_1.max)(pkm.maxPP)(pkm.pp));
                if (pkm.detail && pkm.detail instanceof pokemon_detail_1.default) {
    ...
    moneyAnimation(x, y, gain) {
        ...
        crit.setDepth(depths_1.DEPTH.TEXT_MAJOR);
