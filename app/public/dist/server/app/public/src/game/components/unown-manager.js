...
class UnownManager {
    ...
    addWanderingUnown(pkm, id) {
        (0, pokemon_1.addWanderingPokemon)(this.scene, id, pkm, (unown, id, pointer, tween) => {
            var _a;
            (_a = this.scene.room) === null || _a === void 0 ? void 0 : _a.send(types_1.Transfer.UNOWN_WANDERING, { id });
