...
function ItemDetailTooltipContent({ item, showItemCombinationsTooltip = true }) {
    ...
    const recipes = (0, react_1.useMemo)(() => Item_1.ItemComponents.map((c) => Object.entries(Item_1.ItemRecipe).find(([, recipe]) => (recipe[0] === item && recipe[1] === c) ||
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "game-item-detail", children: [(0, jsx_runtime_1.jsx)("img", { className: "game-item-detail-icon", src: `assets/item/${item}.png` }), (0, jsx_runtime_1.jsxs)("div", { className: "game-item-detail-name", children: [Item_1.ItemRecipe[item] && ((0, jsx_runtime_1.jsx)("div", { className: "game-item-recipe", children: (_a = Item_1.ItemRecipe[item]) === null || _a === void 0 ? void 0 : _a.map((item, i) => ((0, jsx_runtime_1.jsxs)(react_1.default.Fragment, { children: [(0, jsx_runtime_1.jsx)("img", { className: "game-item-detail-icon", src: `assets/item/${item}.png` }, item), i === 0 && " + "] }, `component_${i}_${item}`))) })), t(`item.${item}`)] }), (0, jsx_runtime_1.jsxs)("div", { className: "game-item-detail-stats", children: [itemCategoryLabel && (0, jsx_runtime_1.jsx)("i", { children: itemCategoryLabel }), Object.entries((_b = config_1.ItemStats[item]) !== null && _b !== void 0 ? _b : {}).map(([stat, value]) => ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("img", { src: `assets/icons/${stat}.png`, alt: stat, title: t(`stat.${stat}`) }), (0, jsx_runtime_1.jsx)("span", { children: formatStat(stat, value) })] }, stat)))] }), (0, jsx_runtime_1.jsx)("p", { className: "game-item-detail-description", children: (0, descriptions_1.addIconsToDescription)(t(`item_description.${item}`)) }), recipes.length > 0 && showItemCombinationsTooltip && ((0, jsx_runtime_1.jsx)("div", { className: "game-item-detail-combinations", children: recipes.map(([result, recipe]) => {
                    const otherComponent = recipe[0] == item ? recipe[1] : recipe[0];
                    return ((0, jsx_runtime_1.jsxs)("div", { className: "game-item-detail-combination", children: [(0, jsx_runtime_1.jsx)("p", { children: "+" }), (0, jsx_runtime_1.jsx)("img", { src: `assets/item/${otherComponent}.png`, "data-tooltip-id": "item-detail-recipes-tooltip", "data-tooltip-content": otherComponent, "data-tooltip-place": "right" }), (0, jsx_runtime_1.jsx)("p", { children: "=" }), (0, jsx_runtime_1.jsx)("img", { src: `assets/item/${result}.png`, "data-tooltip-id": "item-detail-recipes-tooltip", "data-tooltip-content": result })] }, result));
