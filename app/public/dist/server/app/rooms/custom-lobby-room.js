    ...
    onCreate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.onMessage(types_1.Transfer.GIVE_TITLE, (client, { uid, title }) => {
                this.dispatcher.dispatch(new lobby_commands_1.GiveTitleCommand(), {
                    client,
                    uid,
                    title,
                });
            ...
            this.onMessage(types_1.Transfer.UNLOCK_ALL_EMOTIONS, (client) => {
                this.dispatcher.dispatch(new lobby_commands_1.UnlockAllEmotionsCommand(), { client });
            });
