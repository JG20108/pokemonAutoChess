...
class GameRoom extends colyseus_1.Room {
    ...
    onCreate(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.state = new game_state_1.default({
                ...
                phase: Game_1.GamePhaseState.TOWN,
                PICK_PHASE_DURATION: 30000,
                status: 'LOADING',
            }, [], options.gameMode, options.specialGameRule || undefined);
            ...
            this.onMessage(types_1.Transfer.UNOWN_WANDERING, (client_1, _a) => __awaiter(this, [client_1, _a], void 0, function* (client, { id: unownId }) {
                try {
                    const pkm = this.state.wanderers.get(unownId);
                    if (!pkm)
                        return;
                    const unownIndex = Pokemon_1.PkmIndex[pkm];
            ...
            this.onMessage(types_1.Transfer.POKEMON_WANDERING, (client, msg) => __awaiter(this, void 0, void 0, function* () {
                if (client.auth) {
                    try {
    ...
    onJoin(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pendingGameId = yield this.presence.hget(client.auth.uid, 'pending_game_id');
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (client && client.auth && client.auth.displayName) {
                    const pendingGameId = yield this.presence.hget(client.auth.uid, 'pending_game_id');
                    if (pendingGameId == undefined && !consented)
                        return;
                    this.presence.hdel(client.auth.uid, 'pending_game_id');
                    const player = this.state.players.get(client.auth.uid);
                ...
                if (this.state.stageLevel >= Config_1.MinStageLevelForGameToCount) {
                    ...
                    if (elligibleToXP) {
                        for (let i = 0; i < bots.length; i++) {
                            ...
                            if (bot) {
                                bot.elo = (0, elo_1.computeElo)(this.transformToSimplePlayer(botPlayer), botPlayer.rank, bot.elo, players, this.state.gameMode);
                                bot.save();
                            }
                        }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (usr) {
                ...
                if (usr.elo != null && elligibleToELO) {
                    const elo = (0, elo_1.computeElo)(this.transformToSimplePlayer(player), rank, usr.elo, humans.map((p) => this.transformToSimplePlayer(p)), this.state.gameMode);
                    if (elo) {
                        if (elo >= 1100) {
