...
class PreparationCommand extends command_1.Command {
}
exports.PreparationCommand = PreparationCommand;
PreparationCommand.CHANGE_SPECIAL_RULE = 'CHANGE_SPECIAL_RULE';
PreparationCommand.ADD_BOT = 'ADD_BOT';
PreparationCommand.REMOVE_BOT = 'REMOVE_BOT';
PreparationCommand.TOGGLE_READY = 'TOGGLE_READY';
PreparationCommand.CHANGE_GAME_MODE = 'CHANGE_GAME_MODE';
PreparationCommand.CHANGE_MIN_RANK = 'CHANGE_MIN_RANK';
PreparationCommand.CHANGE_MAX_RANK = 'CHANGE_MAX_RANK';
PreparationCommand.TOGGLE_NO_ELO = 'TOGGLE_NO_ELO';
PreparationCommand.CHANGE_PASSWORD = 'CHANGE_PASSWORD';
PreparationCommand.CHANGE_NAME = 'CHANGE_NAME';
class PreparationState extends schema_1.Schema {
    ...
    isOwner(client) {
        var _a;
        return ((_a = client.auth) === null || _a === void 0 ? void 0 : _a.uid) === this.ownerId;
    }
    addMessage(message) {
    }
...
exports.PreparationState = PreparationState;
__decorate([
...
class OnRoomChangeSpecialRule extends command_1.Command {
    execute({ client, specialRule }) {
        var _a, _b, _c;
        try {
            const isAdmin = ((_b = this.state.users.get((_a = client.auth) === null || _a === void 0 ? void 0 : _a.uid)) === null || _b === void 0 ? void 0 : _b.role) === types_1.Role.ADMIN;
            const isOwner = ((_c = client.auth) === null || _c === void 0 ? void 0 : _c.uid) === this.state.ownerId;
            if (!isOwner && !isAdmin) {
                return;
            }
