export declare const GADGETS_NAMES: readonly ["trainer_card", "bag", "team_planner", "jukebox", "palette", "synergy_wheel", "gameboy", "pokeguesser", "bot_builder", "tier_list_maker", "sprite_tracker"];
