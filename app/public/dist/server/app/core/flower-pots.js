...
exports.MulchStockCaps = exports.FlowerPotMons = exports.FlowerMonByPot = exports.FlowerPots = exports.FlowerPot = exports.FLOWER_POTS_POSITIONS_RED = exports.FLOWER_POTS_POSITIONS_BLUE = void 0;
...
exports.FlowerMonByPot = {
    [FlowerPot.PINK]: [Pokemon_1.Pkm.HOPPIP, Pokemon_1.Pkm.SKIPLOOM, Pokemon_1.Pkm.JUMPLUFF],
    [FlowerPot.YELLOW]: [Pokemon_1.Pkm.BELLSPROUT, Pokemon_1.Pkm.WEEPINBELL, Pokemon_1.Pkm.VICTREEBEL],
    [FlowerPot.WHITE]: [Pokemon_1.Pkm.CHIKORITA, Pokemon_1.Pkm.BAYLEEF, Pokemon_1.Pkm.MEGANIUM],
    [FlowerPot.BLUE]: [Pokemon_1.Pkm.ODDISH, Pokemon_1.Pkm.GLOOM, Pokemon_1.Pkm.VILEPLUME],
    [FlowerPot.ORANGE]: [Pokemon_1.Pkm.BELLOSSOM]
};
