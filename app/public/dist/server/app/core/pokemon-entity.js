...
class PokemonEntity extends schema_1.Schema {
        ...
        if (this.status.protect ||
            ...
            if (this.status.magicBounce &&
                ...
                const bounceCrit = crit ||
                    (this.effects.has(Effect_1.Effect.ABILITY_CRIT) &&
            ...
            if (attacker && attacker.effects.has(Effect_1.Effect.DOUBLE_DAMAGE)) {
                specialDamage *= 2;
                attacker.effects.delete(Effect_1.Effect.DOUBLE_DAMAGE);
            }
    ...
    removeItemEffect(item) {
        var _a, _b, _c;
        Object.entries((_a = items_1.ItemStats[item]) !== null && _a !== void 0 ? _a : {}).forEach(([stat, value]) => this.applyStat(stat, -value));
        const type = Item_1.SynergyGivenByItem[item];
    ...
    onAttack({ target, board, physicalDamage, specialDamage, trueDamage, totalDamage }) {
        ...
        if (this.effects.has(Effect_1.Effect.TELEPORT_NEXT_ATTACK)) {
            const crit = this.effects.has(Effect_1.Effect.ABILITY_CRIT) &&
    ...
    onHit({ target, board, totalTakenDamage, physicalDamage, specialDamage, trueDamage }) {
        ...
        if (target.status.spikeArmor &&
            ...
            const crit = target.effects.has(Effect_1.Effect.ABILITY_CRIT) &&
    ...
    eatBerry(berry, stealedFrom, inPuffin = false) {
        ...
        switch (berry) {
            case Item_1.Item.AGUAV_BERRY:
                heal((0, number_1.min)(20)(0.5 * this.hp));
