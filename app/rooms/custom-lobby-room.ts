  ...
  async onCreate(): Promise<void> {
    ...
    this.onMessage(
      ...
      (client, { uid, title }: { uid: string; title: Title }) => {
        this.dispatcher.dispatch(new GiveTitleCommand(), {
          client,
          uid,
          title,
        });
    ...
    this.onMessage(Transfer.UNLOCK_ALL_EMOTIONS, (client) => {
      this.dispatcher.dispatch(new UnlockAllEmotionsCommand(), { client });
    });
